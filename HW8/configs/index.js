...
module.exports = {
    ...
    DB_PASSWORD: process.env.DB_PASSWORD || 'i*G&eMg%jtNh',

    EMAIL_SERVICE: process.env.EMAIL_SERVICE || 'gmail',
    EMAIL_LOGIN: process.env.EMAIL_LOGIN || 'testmailmarchuk@gmail.com',
    EMAIL_PASSWORD: process.env.EMAIL_PASSWORD || 'GAYAARUfYOP9',
